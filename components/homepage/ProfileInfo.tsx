...
const ProfileCardInfo = () => {
    return (
        <div className="p-3">
            <h3 className="text-lg font-medium text-gray-800 dark:text-white">Anirudh</h3>
            <h5 className="text-gray-700 dark:text-gray-400">Builder | Educator</h5>
            <div className="mb-2 mt-2 space-y-3">
                <div className="flex items-center">
                    ...
                    <p className="px-2">
                        ...
                        <a
                            ...
                            target="_blank"
                            href="https://corporate.visa.com/en/about-visa.html"
                            rel="noreferrer"
                        >
                            Visa Inc.
                        </a>
                ...
                <div className="flex items-center">
                    ...
                    <p className="px-2">
                        Bengaluru - India, <Twemoji emoji="india-india-flag" />
                    </p>
                </div>
                <div className="flex items-center">
